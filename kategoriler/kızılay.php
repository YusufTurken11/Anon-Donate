...
<div class="album">
  <div class="container mt-4">
    ...
    <div class="mb-5">
      <h1 class="text-center">TÜRK KIZILAY YARDIM KAMPANYALARI
      </h1>
    </div>
    ...
    <?php
      $select_product = mysqli_query($conn, "SELECT * FROM `products` WHERE categorie = 'kızılay'") or die('query failed');
      ...
      <div style="position: relative;" class="col mb-5">
        ...
        <div style="box-shadow: 0 0 8px rgba(5,5,5,.3);" class="card">
          ...
          <div style="height: 180px" class="card-body">
            ...
            <h4 name="product_name" style="text-align: center"><?= $fetch_product['product_name']; ?></h4>
            </a>
